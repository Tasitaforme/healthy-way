import{s as n,p as w,q as G,j as e,a as S,W as K,I as u,b as y,t as v,S as V,v as f,w as p,B as N,f as J,x as me,i as C,c as ue,e as ge,H as U,F as Y,y as m,h as R,z as T,A as X,u as D,D as fe,E as z,G as je,J as we,_ as A,K as ye,r as j,M as $,N as be,O as Ae,P as Fe,Q as L,R as M,T as _,U as Ce,V as Re,X as Se,C as De}from"./index-eeab6bbc.js";import{M as ee,s as q,d as ke,b as te,l as ne,a as ie,c as re}from"./formikDiary-71ec7f8e.js";import{C as se,A as ae,D as oe}from"./index-78b6b6c6.js";import{g as ve,a as Qe,R as Be,F as Ie,b as Pe,c as Ee,d as Ne}from"./getRecommendedFood-5c8fa58a.js";const We=n.main`
  padding-top: 16px;
  padding-bottom: 80px;
...
`;function Gt({type:t,setFormActive:r,setModalActive:a}){const o={name:"",carbohydrate:"",protein:"",fat:"",calories:""},s=D();function x(d){return d.charAt(0).toUpperCase()+d.slice(1)}const h=async(d,l)=>{try{await s(be({diary:x(t),...d})).unwrap(),A.success("You have successfully added your meal!"),r(!1),a(!1)}catch(i){console.log(i),A.error(`Something went wrong! 
 ${i.message}`)}l.resetForm()};return e.jsx(Y,{initialValues:o,validationSchema:ke,onSubmit:h,children:({errors:d,touched:l,isSubmitting:i,isValid:c})=>e.jsxs(kt,{children:[e.jsxs(vt,{children:[e.jsxs(Qt,{children:[e.jsx(C,{type:"text",name:"name",placeholder:"The name of the product or dish",autoComplete:"off",className:l.name?d.name?"input-error":"input-success":"input-normal"}),e.jsx(R,{component:"p",name:"name"})]}),e.jsxs(Bt,{children:[e.jsx(C,{type:"number",name:"carbohydrate",placeholder:"Carbonoh.",autoComplete:"off",className:l.carbohydrate?d.carbohydrate?"input-error":"input-success":"input-normal"}),e.jsx(R,{component:"p",name:"carbohydrate"})]}),e.jsxs(It,{children:[e.jsx(C,{type:"number",name:"protein",placeholder:"Protein",autoComplete:"off",className:l.protein?d.protein?"input-error":"input-success":"input-normal"}),e.jsx(R,{component:"p",name:"protein"})]}),e.jsxs(Pt,{children:[e.jsxs(he,{children:[e.jsx(C,{type:"number",name:"fat",placeholder:"Fat",autoComplete:"off",className:l.fat?d.fat?"input-error":"input-success":"input-normal"}),e.jsx(R,{component:"p",name:"fat"})]}),e.jsxs(Et,{children:[e.jsx(C,{type:"number",name:"calories",placeholder:"Calories",autoComplete:"off",className:l.calories?d.calories?"input-error":"input-success":"input-normal"}),e.jsx(R,{component:"p",name:"calories"})]})]})]}),e.jsxs(Nt,{children:[e.jsx(Wt,{type:"submit",disabled:!c||i,children:"Confirm"}),e.jsx(Ot,{type:"button",onClick:()=>{r(!1),a(!1)},children:e.jsx(X,{children:"Cancel"})})]})]})})}function Kt({modalData:t,setModalData:r}){const{type:a}=t,o=Ae(),s=D(),{meals:x}=w(q),[h,d]=j.useState(!1),l=async i=>{try{await s(Fe(i)).unwrap(),A.success("You have successfully removed your meal!")}catch(c){A.error(`Something went wrong! 
 ${c}`)}};return e.jsx(e.Fragment,{children:e.jsx(ee,{modalActive:!!t,setModalActive:r,children:e.jsxs(At,{children:[e.jsx(U,{children:"Record your meal"}),e.jsxs(Ft,{children:[a==="breakfast"&&e.jsx("img",{srcSet:`${B} 1x, ${te} 2x`,src:B,alt:"Breakfast"}),a==="lunch"&&e.jsx("img",{srcSet:`${I} 1x, ${ne} 2x`,src:I,alt:"Lunch"}),a==="dinner"&&e.jsx("img",{srcSet:`${P} 1x, ${ie} 2x`,src:P,alt:"Dinner"}),a==="snack"&&e.jsx("img",{srcSet:`${E} 1x, ${re} 2x`,src:E,alt:"Snack"}),e.jsx(Ct,{children:a})]}),h||x[`${a}`]&&e.jsx(Rt,{children:x[`${a}`].map(i=>e.jsxs(St,{children:[e.jsx(Dt,{children:i.name}),e.jsxs(le,{children:[e.jsxs(f,{children:[e.jsx(p,{children:"Carbonohidrates:"}),e.jsx(m,{children:i.carbohydrate})]}),e.jsxs(f,{children:[e.jsx(p,{children:"Protein:"}),e.jsx(m,{children:i.protein})]}),e.jsxs(f,{children:[e.jsx(p,{children:"Fat:"}),e.jsx(m,{children:i.fat})]}),e.jsxs(f,{children:[e.jsx(p,{children:"Calories:"}),e.jsx(m,{children:i.calories})]}),e.jsx(z,{type:"button",onClick:()=>{l({id:i.id,diary:a})},children:e.jsx(u,{width:"20px",height:"20px",stroke:"var(--green-light)",children:e.jsx("use",{href:`${y}#trash`})})})]})]},o))}),!h&&e.jsx(H,{children:e.jsxs(de,{onClick:()=>d(!0),children:[e.jsx(u,{width:"16px",height:"16px",children:e.jsx("use",{href:`${y}#add`})}),e.jsx(xe,{children:"Add more"})]})}),h&&e.jsx(Gt,{setFormActive:d,setModalActive:r,type:a}),e.jsx(H,{})]})})})}function Ut({data:t,meals:r}){const[a,o]=j.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsxs(wt,{children:[e.jsxs(yt,{children:[t.mealType==="breakfast"&&e.jsx("img",{srcSet:`${B} 1x, ${te} 2x`,src:B,alt:"Breakfast"}),t.mealType==="lunch"&&e.jsx("img",{srcSet:`${I} 1x, ${ne} 2x`,src:I,alt:"Lunch"}),t.mealType==="dinner"&&e.jsx("img",{srcSet:`${P} 1x, ${ie} 2x`,src:P,alt:"Dinner"}),t.mealType==="snack"&&e.jsx("img",{srcSet:`${E} 1x, ${re} 2x`,src:E,alt:"Snack"}),e.jsx(bt,{children:t.mealType})]}),r[`${t.mealType}`].length===0?e.jsxs(de,{onClick:()=>o({type:t.mealType,meals:r}),children:[e.jsx(u,{width:"16px",height:"16px",children:e.jsx("use",{href:`${y}#add`})}),e.jsx(xe,{children:"Record your meal"})]}):e.jsxs(le,{children:[e.jsxs(f,{children:[e.jsx(p,{children:"Carbonohidrates:"}),e.jsx(m,{children:t.carbohydrate})]}),e.jsxs(f,{children:[e.jsx(p,{children:"Protein:"}),e.jsx(m,{children:t.protein})]}),e.jsxs(f,{children:[e.jsx(p,{children:"Fat:"}),e.jsx(m,{children:t.fat})]}),e.jsx(z,{type:"button",onClick:()=>o({type:t.mealType,meals:r}),children:e.jsx(u,{width:"20px",height:"20px",stroke:"var(--green-light)",children:e.jsx("use",{href:`${y}#trash`})})})]})]}),e.jsx(Kt,{modalData:a,setModalData:o})]})}function Tt(){D();const{meals:t}=w(q),r=st(t);return e.jsxs(gt,{children:[e.jsxs(ft,{children:[e.jsx(S,{children:"Diary"}),e.jsx(L,{to:"/diary",children:e.jsx(M,{children:"See more"})})]}),e.jsx(jt,{children:r.map((a,o)=>e.jsx(Ut,{data:a,meals:t},o))})]})}function zt(){const t=w(_),[r,a]=j.useState([]),o=ve(r,4);return j.useEffect(()=>{t&&Qe().then(s=>{a(s)}).catch(s=>console.log(s))},[t]),e.jsxs(Be,{children:[e.jsx(S,{children:"Recommended food"}),r.length===0?e.jsx($,{}):e.jsx(Ie,{children:o.map(s=>e.jsxs(Pe,{children:[e.jsx("img",{src:s.img,alt:s.name,width:"46px"}),e.jsxs("div",{children:[e.jsx(Ee,{children:s.name}),e.jsxs(Ne,{children:[e.jsx(p,{children:s.amount}),e.jsxs(m,{children:[s.calories," calories"]})]})]})]},s._id))}),e.jsxs(L,{to:"/recommended-food",children:[e.jsx(M,{children:"See more"}),e.jsx(u,{width:"16px",height:"16px",children:e.jsx("use",{href:`${y}#arrow-right`})})]})]})}function Vt(){const t=D(),r=w(_),{weight:a,goal:o}=w(G);j.useEffect(()=>{r&&t(Ce())},[r,t]),j.useEffect(()=>{r&&t(Re())},[t]),j.useEffect(()=>{r&&t(Se())},[a,o]);const[s,x]=j.useState(!1);return s?document.body.style.overflow="hidden":document.body.style.overflow="auto",e.jsx(We,{children:e.jsxs(De,{children:[e.jsxs(Oe,{children:[e.jsx(U,{children:"Today"}),e.jsxs(L,{to:"/dashboard",children:[e.jsx(M,{children:"On the way to the goal"}),e.jsx(u,{width:"16px",height:"16px",children:e.jsx("use",{href:`${y}#arrow-right`})})]})]}),e.jsxs(Ge,{children:[e.jsx(Te,{}),e.jsx(rt,{modalActive:s,setModalActive:x}),e.jsx(ut,{}),e.jsx(Tt,{}),e.jsx(zt,{})]})]})})}export{Vt as default};
