import{s as n,b as g,c as T,j as e,d as w,a as y,e as X,u as D,f as $,g as _,_ as R,h as ee,i as te,k as re,m as ie,o as ne,C as ae,p as se,n as O}from"./index-edcf3ddb.js";import{a as F,W as B,I as j,c as k,S as G,d as A,b as m,B as v,H as z,e as f,f as L,g as oe,h as q,i as ce,j as P,k as E}from"./Components.styled-3fb1c3c3.js";import{c as le,e as de,a as xe,F as he,b as pe}from"./Formik.styled-9008763f.js";import{c as me,d as ue}from"./index.esm-17f54d8a.js";import{C as Z,A as M,D as V}from"./index-98f448e1.js";import{b as ge,l as fe,d as je,s as we}from"./snack@2x-c4dbc989.js";const ye=n.div`
  display: flex;
  flex-wrap: nowrap;
  align-items: center;
...
`,Ne=n(v)`
  width: 100%;
`,Ue=me().shape({water:ue().min(100,"A quantity of water must be at least 100 ml").max(5e3,"A quantity of water must be at least 5000 ml").required("A quantity of water is required").typeError("A quantity must be a number")});function We({handleUpdate:t,setModalActive:i}){const s=r=>{t(r)};return e.jsxs(Pe,{children:[e.jsx(z,{children:"Add water intake"}),e.jsx(he,{initialValues:{water:""},validationSchema:Ue,onSubmit:s,children:({errors:r,touched:o,isSubmitting:d,isValid:x,dirty:p})=>e.jsxs(Oe,{children:[e.jsx(Ge,{children:e.jsx(f,{children:"How much water"})}),e.jsx(Ke,{type:"text",name:"water",placeholder:"Enter milliliters",autoComplete:"off",className:o.water?r.water?"input-error":"input-success":"input-normal"}),e.jsx(pe,{component:"p",name:"water"}),e.jsx(Ne,{type:"submit",disabled:!x||d||!p,children:e.jsx(L,{children:"Confirm"})})]})}),e.jsx(Ee,{type:"button",onClick:()=>i(!1),children:e.jsx(oe,{children:"Cancel"})})]})}const Te=n.div`
  height: 100vh;
  width: 100vw;
