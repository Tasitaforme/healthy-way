import{s as a,d as g,e as T,j as e,f as w,u as k,g as _,h as ee,_ as C,i as te,r as y,k as re,m as z,o as L,p as se,C as ie,q as ne,n as E}from"./index-d28cb229.js";import{a as D,W as P,I as f,b as R,S as G,c as b,d as m,B as Q,H as q,e as j,f as Z,g as ae,h as M,i as oe,j as v,k as O}from"./Components.styled-f8098fdd.js";import{a as le,h as ce,b as de,d as xe,f as he,F as pe,c as me}from"./Formik.styled-d4687912.js";import{M as ue,s as V,b as ge,l as je,d as fe,a as we}from"./snack@2x-d3c61ee3.js";import{C as H,A as J,D as Y}from"./index-c98b89f0.js";import{g as ye,a as Ae,R as be,F as Fe,b as Ce,c as Re,d as De}from"./getRecommendedFood-a9d1f12c.js";import{C as Se,D as ke}from"./DeleteUser-d6f0c1b5.js";import"./SignInForm.styled-ab8bf87f.js";import"./SignInPage.styled-bf438acf.js";const Qe=a.div`
  display: flex;
  flex-wrap: nowrap;
  align-items: center;
...
`,Ve=a(Q)`
  width: 100%;
`,He=xe().shape({water:he().min(100,"A quantity of water must be at least 100 ml").max(5e3,"A quantity of water must be at least 5000 ml").required("A quantity of water is required").typeError("A quantity must be a number")});function Je({handleUpdate:t,setModalActive:s}){const o=n=>{t(n)};return e.jsxs(ze,{children:[e.jsx(q,{children:"Add water intake"}),e.jsx(pe,{initialValues:{water:""},validationSchema:He,onSubmit:o,children:({errors:n,touched:r,isSubmitting:d,isValid:x,dirty:p})=>e.jsxs(qe,{children:[e.jsx(Ze,{children:e.jsx(j,{children:"How much water"})}),e.jsx(Me,{type:"text",name:"water",placeholder:"Enter milliliters",autoComplete:"off",className:r.water?n.water?"input-error":"input-success":"input-normal"}),e.jsx(me,{component:"p",name:"water"}),e.jsx(Ve,{type:"submit",disabled:!x||d||!p,children:e.jsx(Z,{children:"Confirm"})})]})}),e.jsx(Le,{type:"button",onClick:()=>s(!1),children:e.jsx(ae,{children:"Cancel"})})]})}const X=t=>t.water;function Ye({modalActive:t,setModalActive:s}){const o=k(),{water:n=0,error:r}=g(X),d=g(_),x=d!==null?d*1e3:0,p=x-n,c=Math.max(0,p),i=Math.round(n*100/x),l=async u=>{s(!1);try{await o(ee({water:+u.water})).unwrap(),C.success("Added to the total amount of water drunk for today!")}catch(A){r&&C.error(`${r}`),C.error(`${A}`)}},h=async()=>{try{await o(te()).unwrap(),C.success("You have successfully remove daily water!")}catch(u){C.error(`${u}`)}};return e.jsxs(Oe,{children:[e.jsx(D,{children:"Water"}),e.jsxs(Ee,{children:[e.jsx(Ue,{children:e.jsx(Ne,{height:`${i}%`,children:e.jsxs(We,{$color:i<84?"var(--violet)":"var(--black-primary)",$top:i<84?"-28px":"28px",children:[i,"%"]})})}),e.jsxs(Te,{children:[e.jsx(M,{type:"button",onClick:()=>h(),children:e.jsx(f,{width:"20px",height:"20px",stroke:"var(--green-light)",children:e.jsx("use",{href:`${w}#trash`})})}),e.jsx(Ge,{children:"Water consumption"}),e.jsxs(Ke,{children:[e.jsxs(b,{children:[e.jsx(oe,{children:n||0}),e.jsx(m,{color:"var(--grey-light)",children:"ml"})]}),e.jsxs(b,{children:[e.jsx(m,{children:"left:"}),e.jsx(j,{children:c||0}),e.jsx(m,{color:"var(--grey-light)",children:"ml"})]})]}),e.jsxs(Q,{type:"button",onClick:()=>s(!0),children:[e.jsx(f,{width:"16px",height:"16px",children:e.jsx("use",{href:`${w}#add`})}),e.jsx(Z,{children:"Add water intake"})]})]})]}),t&&e.jsx(ue,{modalActive:t,setModalActive:s,children:e.jsx(Je,{handleUpdate:l,setModalActive:s})})]})}const Xe=t=>{function s(n){const r={calories:0,carbohydrate:0,protein:0,fat:0};return n.forEach(({calories:d,carbohydrate:x,protein:p,fat:c})=>{r.calories+=d,r.carbohydrate+=x,r.protein+=p,r.fat+=c}),{calories:r.calories,carbohydrate:r.carbohydrate,protein:r.protein,fat:r.fat}}return Object.keys(t).reduce((n,r)=>(Array.isArray(t[r])&&n.push({mealType:r,...s(t[r])}),n),[])},$e=(t={})=>{const s={calories:0,carbohydrate:0,protein:0,fat:0};return Object.values(t).forEach(o=>{Array.isArray(o)&&o.forEach(({calories:n,carbohydrate:r,protein:d,fat:x})=>{s.calories+=n,s.carbohydrate+=r,s.protein+=d,s.fat+=x})}),s},_e=a.li`
  min-width: 100%;
  @media screen and (min-width: 1440px) {
    min-width: 560px;
  }
