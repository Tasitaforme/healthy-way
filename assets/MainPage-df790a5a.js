import{s as o,d as u,e as Q,j as e,f as b,r as w,g as ae,u as B,h as ne,i as oe,_ as f,k as ie,m as ce,o as Z,p as V,q as M,a as le,t as de,C as xe,v as he,n as K}from"./index-ec9a0bbe.js";import{a as A,W as O,I as y,b as k,S as T,c as C,d as m,B as R,H as Y,e as j,f as H,g as pe,h as J,i as me,j as N,k as U}from"./Components.styled-9b5d3906.js";import{c as ue,h as ge,a as v,d as fe,f as je,F as G,b as P}from"./Formik.styled-d3d36689.js";import{C as X,A as $,D as _}from"./index-5c1cb802.js";import{b as we,l as ye,d as be,s as Ae}from"./snack@2x-c4dbc989.js";import{g as Fe,a as Ce,R as Re,F as Se,b as ke,c as De,d as ve}from"./getRecommendedFood-152e6f92.js";import{c as Pe,S as ee,d as Qe}from"./SignInForm.styled-6e0a2cd9.js";import"./SignInPage.styled-bec28f58.js";const Be=o.div`
  display: flex;
  flex-wrap: nowrap;
  align-items: center;
...
`;function Ne(){const{baseWater:t,BMR:r}=u(Q),i=t!==null?t*1e3:0;return e.jsxs(Ee,{children:[e.jsx(A,{children:"Daily goal"}),e.jsx(O,{children:e.jsxs(Oe,{children:[e.jsxs("li",{children:[e.jsx(y,{width:"80px",height:"80px",stroke:"var(--green)",children:e.jsx("use",{href:`${b}#bubble`})}),e.jsxs("div",{children:[e.jsx(k,{color:"var(--grey-light)",children:"Calories"}),e.jsx(T,{children:r||0})]})]}),e.jsxs("li",{children:[e.jsx(y,{width:"80px",height:"80px",stroke:"var(--violet)",children:e.jsx("use",{href:`${b}#water`})}),e.jsxs("div",{children:[e.jsx(k,{color:"var(--grey-light)",children:"Water"}),e.jsxs(C,{children:[e.jsx(T,{children:i||0}),e.jsx(m,{color:"var(--grey-light)",children:"ml"})]})]})]})]})})]})}const Ue=o.li`
  @media screen and (min-width: 834px) {
    min-width: 380px;
  }
  @media screen and (min-width: 1440px) {
...
`,Je=o(R)`
  width: 100%;
`,Xe=fe().shape({water:je().min(100,"A quantity of water must be at least 100 ml").max(5e3,"A quantity of water must be at least 5000 ml").required("A quantity of water is required").typeError("A quantity must be a number")});function $e({handleUpdate:t,setModalActive:r}){const i=a=>{t(a)};return e.jsxs(Ze,{children:[e.jsx(Y,{children:"Add water intake"}),e.jsx(G,{initialValues:{water:""},validationSchema:Xe,onSubmit:i,children:({errors:a,touched:s,isSubmitting:c,isValid:d,dirty:p})=>e.jsxs(Me,{children:[e.jsx(Ye,{children:e.jsx(j,{children:"How much water"})}),e.jsx(He,{type:"text",name:"water",placeholder:"Enter milliliters",autoComplete:"off",className:s.water?a.water?"input-error":"input-success":"input-normal"}),e.jsx(P,{component:"p",name:"water"}),e.jsx(Je,{type:"submit",disabled:!d||c||!p,children:e.jsx(H,{children:"Confirm"})})]})}),e.jsx(Ve,{type:"button",onClick:()=>r(!1),children:e.jsx(pe,{children:"Cancel"})})]})}const _e=o.div`
  height: 100vh;
  width: 100vw;
...
`,tt=document.querySelector("#root_modal");function rt({modalActive:t,setModalActive:r,children:i}){return t?document.body.style.overflow="hidden":document.body.style.overflow="auto",w.useEffect(()=>{const a=s=>{s.code==="Escape"&&r(!1)};return window.addEventListener("keydown",a),()=>{window.removeEventListener("keydown",a)}},[r]),ae.createPortal(e.jsx(_e,{className:t?"active":"",onClick:()=>r(!1),children:e.jsx(et,{className:t?"active":"",onClick:a=>a.stopPropagation(),children:i})}),tt)}const te=t=>t.water;function st({modalActive:t,setModalActive:r}){const i=B(),{water:a=0,error:s}=u(te),c=u(ne),d=c!==null?c*1e3:0,p=d-a,x=Math.max(0,p),n=Math.round(a*100/d),l=async g=>{r(!1);try{await i(oe({water:+g.water})).unwrap(),f.success("Added to the total amount of water drunk for today!")}catch(F){s&&f.error(`${s}`),f.error(`${F}`)}},h=async()=>{try{await i(ie()).unwrap(),f.success("You have successfully remove daily water!")}catch(g){f.error(`${g}`)}};return e.jsxs(Ue,{children:[e.jsx(A,{children:"Water"}),e.jsxs(Ge,{children:[e.jsx(We,{children:e.jsx(Le,{height:`${n}%`,children:e.jsxs(qe,{$color:n<84?"var(--violet)":"var(--black-primary)",$top:n<84?"-28px":"28px",children:[n,"%"]})})}),e.jsxs(ze,{children:[e.jsx(J,{type:"button",onClick:()=>h(),children:e.jsx(y,{width:"20px",height:"20px",stroke:"var(--green-light)",children:e.jsx("use",{href:`${b}#trash`})})}),e.jsx(Ke,{children:"Water consumption"}),e.jsxs(Te,{children:[e.jsxs(C,{children:[e.jsx(me,{children:a||0}),e.jsx(m,{color:"var(--grey-light)",children:"ml"})]}),e.jsxs(C,{children:[e.jsx(m,{children:"left:"}),e.jsx(j,{children:x||0}),e.jsx(m,{color:"var(--grey-light)",children:"ml"})]})]}),e.jsxs(R,{type:"button",onClick:()=>r(!0),children:[e.jsx(y,{width:"16px",height:"16px",children:e.jsx("use",{href:`${b}#add`})}),e.jsx(H,{children:"Add water intake"})]})]})]}),t&&e.jsx(rt,{modalActive:t,setModalActive:r,children:e.jsx($e,{handleUpdate:l,setModalActive:r})})]})}const re=t=>t.diary,at=t=>{function r(a){const s={calories:0,carbohydrate:0,protein:0,fat:0};return a.forEach(({calories:c,carbohydrate:d,protein:p,fat:x})=>{s.calories+=c,s.carbohydrate+=d,s.protein+=p,s.fat+=x}),{calories:s.calories,carbohydrate:s.carbohydrate,protein:s.protein,fat:s.fat}}return Object.keys(t).map(a=>({mealType:a,...r(t[a])}))},nt=t=>{const r={calories:0,carbohydrate:0,protein:0,fat:0};return Object.values(t).forEach(i=>{i.forEach(({calories:a,carbohydrate:s,protein:c,fat:d})=>{r.calories+=a,r.carbohydrate+=s,r.protein+=c,r.fat+=d})}),r},ot=o.li`
  min-width: 100%;
  @media screen and (min-width: 1440px) {
    min-width: 560px;
  }
...
`,ct=o.ul``;X.register($);const lt=({calories:t,baseCalories:r})=>{const i=w.useMemo(()=>t>=r?100:Math.round(t/r*100),[t,r]),a=t>=r?"red":"rgba(69, 255, 188, 1)",s=t>=r?[0]:[50],c={datasets:[{data:[i,100-i],backgroundColor:[a,"rgba(41, 41, 40, 1)"],borderColor:["rgba(69, 255, 188, 0)"],borderRadius:s,cutout:"80%"}]},d={id:"textCenter",beforeDatasetsDraw(x){const{ctx:n}=x,l=x.getDatasetMeta(0).data[0].x,h=x.getDatasetMeta(0).data[0].y;n.save(),n.font="32px Poppins",n.fillStyle="#ffffff",n.textAlign="center",n.textBaseline="middle",n.fillText(t,l,h-12),n.font="14px sans-serif",n.fillStyle="#B6B6B6",n.fillText("calories",l,h+15)}},p={id:"backgroundCircle",beforeDatasetsDraw(x){const{ctx:n}=x;n.save();const l=x.getDatasetMeta(0).data[0].x,h=x.getDatasetMeta(0).data[0].y,g=x.getDatasetMeta(0).data[0].innerRadius,F=x.getDatasetMeta(0).data[0].outerRadius,S=F-g,D=Math.PI/180;n.beginPath(),n.lineWidth=S,n.strokeStyle="rgba(41, 41, 40, 1)",n.arc(l,h,F-S/2,0,D*360,!1),n.stroke()}};return e.jsx("div",{className:"doughnut",style:{height:168,width:168},children:e.jsx(_,{plugins:[d,p],data:c})})},dt=lt,E=o.li`
  display: flex;
  flex-direction: row;
  column-gap: 12px;
  align-items: center;
...
`;X.register($);const pt=({title:t,arcColor:r,nutrient:i,baseNutrient:a=0})=>{const s=w.useMemo(()=>i>=a?100:Math.round(i/a*100),[a,i]),c=i>=a?[0]:[50],d={datasets:[{data:[s,100-s],backgroundColor:[r,"rgba(41, 41, 40, 1)"],borderColor:["rgba(69, 255, 188, 0)"],borderRadius:c,cutout:"80%"}]},p={id:"textCenter",beforeDatasetsDraw(n){const{ctx:l}=n,h=n.getDatasetMeta(0).data[0].x,g=n.getDatasetMeta(0).data[0].y;l.save(),l.font="14px Poppins",l.fillStyle="#B6B6B6",l.textAlign="center",l.textBaseline="middle",l.fillText(`${s}%`,h,g)}},x={id:"backgroundCircle",beforeDatasetsDraw(n){const{ctx:l}=n;l.save();const h=n.getDatasetMeta(0).data[0].x,g=n.getDatasetMeta(0).data[0].y,F=n.getDatasetMeta(0).data[0].innerRadius,S=n.getDatasetMeta(0).data[0].outerRadius,D=S-F,se=Math.PI/180;l.beginPath(),l.lineWidth=D,l.strokeStyle="rgba(41, 41, 40, 1)",l.arc(h,g,S-D/2,0,se*360,!1),l.stroke()}};return e.jsxs(ht,{children:[e.jsx("div",{className:"doughnut",style:{height:48,width:48},children:e.jsx(_,{plugins:[p,x],data:d})}),e.jsxs("div",{children:[e.jsx(k,{children:t}),e.jsxs(xt,{children:[e.jsxs(E,{children:[e.jsx(m,{children:"Goal:"}),e.jsx(j,{children:a||0})]}),e.jsxs(E,{children:[e.jsx(m,{children:"left:"}),e.jsx(j,{children:i>=a?0:a-i})]})]})]})]})},I=pt;function mt(){const t=B(),{fat:r,protein:i,carbohydrate:a,BMR:s}=u(Q),{meals:c,isLoading:d}=u(re),{fat:p,protein:x,carbohydrate:n,calories:l}=nt(c);w.useEffect(()=>{t(ce()).unwrap()},[p,x,n,l]);const h=["Carbonohidrates","Protein","Fat"];return e.jsxs(ot,{children:[e.jsx(A,{children:"Food"}),d?e.jsx(Z,{}):e.jsxs(it,{children:[e.jsx(dt,{calories:l,baseCalories:s}),e.jsxs(ct,{children:[e.jsx(I,{title:h[0],arcColor:"#FFC4F7",nutrient:n,baseNutrient:a}),e.jsx(I,{title:h[1],arcColor:"#FFF3B7",nutrient:x,baseNutrient:i}),e.jsx(I,{title:h[2],arcColor:"#B6B6B6",nutrient:p,baseNutrient:r})]})]})]})}const ut=o.li`
  width: 100%;
...
`;function At({data:t,meals:r}){return e.jsxs(jt,{children:[e.jsxs(wt,{children:[t.mealType==="breakfast"&&e.jsx("img",{srcSet:`${W} 1x, ${we} 2x`,src:W,alt:"Breakfast"}),t.mealType==="lunch"&&e.jsx("img",{srcSet:`${q} 1x, ${ye} 2x`,src:q,alt:"Lunch"}),t.mealType==="dinner"&&e.jsx("img",{srcSet:`${L} 1x, ${be} 2x`,src:L,alt:"Dinner"}),t.mealType==="snack"&&e.jsx("img",{srcSet:`${z} 1x, ${Ae} 2x`,src:z,alt:"Snack"}),e.jsx(yt,{children:t.mealType})]}),r[`${t.mealType}`]==[]?e.jsx("div",{children:e.jsx("p",{children:"Record your meal"})}):e.jsxs(bt,{children:[e.jsxs(C,{children:[e.jsx(m,{children:"Carbonohidrates:"}),e.jsx(j,{children:t.carbohydrate})]}),e.jsxs(C,{children:[e.jsx(m,{children:"Protein:"}),e.jsx(j,{children:t.protein})]}),e.jsxs(C,{children:[e.jsx(m,{children:"Fat:"}),e.jsx(j,{children:t.fat})]}),e.jsx(J,{type:"button",onClick:()=>console.log("ТУУУ"),children:e.jsx(y,{width:"20px",height:"20px",stroke:"var(--green-light)",children:e.jsx("use",{href:`${b}#trash`})})})]})]})}function Ft(){B();const{meals:t,firstLoad:r}=u(re),i=at(t);return e.jsxs(ut,{children:[e.jsxs(gt,{children:[e.jsx(A,{children:"Diary"}),e.jsx(N,{to:"/diary",children:e.jsx(U,{children:"See more"})})]}),e.jsx(ft,{children:i.map((a,s)=>e.jsx(At,{data:a,meals:t},s))})]})}function Ct(){const t=u(V),[r,i]=w.useState([]),a=Fe(r,4);return w.useEffect(()=>{t&&Ce().then(s=>{i(s)}).catch(s=>console.log(s))},[t]),e.jsxs(Re,{children:[e.jsx(A,{children:"Recommended food"}),r.length===0?e.jsx(Z,{}):e.jsx(Se,{children:a.map(s=>e.jsxs(ke,{children:[e.jsx("img",{src:s.img,alt:s.name,width:"46px"}),e.jsxs("div",{children:[e.jsx(De,{children:s.name}),e.jsxs(ve,{children:[e.jsx(m,{children:s.amount}),e.jsxs(j,{children:[s.calories," calories"]})]})]})]},s._id))}),e.jsxs(N,{to:"/recommended-food",children:[e.jsx(U,{children:"See more"}),e.jsx(y,{width:"16px",height:"16px",children:e.jsx("use",{href:`${b}#arrow-right`})})]})]})}const Rt=async t=>{try{const{data:r}=await M.put("/api/auth/change-password",t);return r}catch(r){return r}};function St(){const{email:t}=u(Q),r={password:"",newPassword:""},i=async(a,s)=>{try{await Rt({email:t,...a}),f.success("Your password has been successfully changed!")}catch(c){f.error(`Something went wrong! ${c}`)}s.resetForm()};return e.jsxs("section",{style:{paddingTop:"24px",paddingBottom:"24px"},children:[e.jsx(A,{style:{marginBottom:"12px"},children:"Change password"}),e.jsx(G,{initialValues:r,validationSchema:Pe,onSubmit:i,children:({errors:a,touched:s,isSubmitting:c,isValid:d})=>e.jsxs(ee,{children:[e.jsx(v,{type:"password",name:"password",placeholder:"Password",autoComplete:"off",className:s.quantity?a.quantity?"input-error":"input-success":"input-normal"}),e.jsx(P,{component:"p",name:"password"}),e.jsx(v,{type:"password",name:"newPassword",placeholder:"New password",autoComplete:"off",className:s.quantity?a.quantity?"input-error":"input-success":"input-normal"}),e.jsx(P,{component:"p",name:"newPassword"}),e.jsx(R,{type:"submit",disabled:!d||c,children:"Update Password"})]})})]})}const kt=async t=>{try{const{data:r}=await M.delete("/api/auth/delete",{data:t});return console.log(r),r}catch(r){return console.log(r.response.data),r.response.data}};function Dt(){const t=le(),{email:r}=u(Q),i=async(a,s)=>{try{await kt({email:r,...a}),f.success("You have successfully delete your account!"),t("/welcome")}catch(c){console.log(c.message),f.error(`Something went wrong! ${c.message}`)}s.resetForm()};return e.jsxs("section",{style:{paddingTop:"24px",paddingBottom:"24px"},children:[e.jsx(A,{style:{marginBottom:"12px",color:"var(--error-color)"},children:"Delete account"}),e.jsx(m,{style:{marginBottom:"12px"},children:"Once you delete your account, there is no going back. Please be certain."}),e.jsx(G,{initialValues:{password:""},validationSchema:Qe,onSubmit:i,children:({errors:a,touched:s,isSubmitting:c,isValid:d})=>e.jsxs(ee,{children:[e.jsx(v,{type:"password",name:"password",placeholder:"Password",autoComplete:"off",className:s.quantity?a.quantity?"input-error":"input-success":"input-normal"}),e.jsx(P,{component:"p",name:"password"}),e.jsx(R,{type:"submit",disabled:!d||c,children:"Delete your account"})]})})]})}function Ut(){const t=B(),r=u(V),{water:i}=u(te);w.useEffect(()=>{r&&t(de())},[r,i]);const[a,s]=w.useState(!1);a?document.body.style.overflow="hidden":document.body.style.overflow="auto";const c=async()=>{try{await t(he()).unwrap(),K.success("You have successfully logged out!")}catch{K.error("Something went wrong !")}};return e.jsx("main",{children:e.jsxs(xe,{children:[e.jsxs(Be,{children:[e.jsx(Y,{children:"Today"}),e.jsxs(N,{to:"/dashboard",children:[e.jsx(U,{children:"On the way to the goal"}),e.jsx(y,{width:"16px",height:"16px",children:e.jsx("use",{href:`${b}#arrow-right`})})]})]}),e.jsxs(Ie,{children:[e.jsx(Ne,{}),e.jsx(st,{modalActive:a,setModalActive:s}),e.jsx(mt,{}),e.jsx(Ft,{}),e.jsx(Ct,{})]}),e.jsx(R,{type:"submit",onClick:()=>c(),children:"Sign out"}),e.jsx(St,{}),e.jsx(Dt,{})]})})}export{Ut as default};
