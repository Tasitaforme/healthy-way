import{m as x,s as o,g as p,i as l,j as e,F as h,h as g,_ as n,C as u}from"./index-4154ed12.js";import{B as w,H as b}from"./Components.styled-89fbb40b.js";import{S as f,H as j,a as y}from"./SignInPage.styled-3be779f5.js";import{S as F,f as S}from"./SignInForm.styled-f2c5c77d.js";import{M as k,F as $,I as T,B as M,T as v}from"./SignUpImage.styled-11745d1e.js";import{w as D,a as B,b as I,c as P,d as E,e as H}from"./watch-desk@2x-2cdfc254.js";const W=x.create({baseURL:"https://healthy-way-app.onrender.com"}),C=async t=>{try{const{data:s}=await W.post("/api/auth/forgot-password",t);return s}catch(s){return s.response.data}},m=o(p)`
  position: absolute;
  top: 30px;
  left: 10px;
`,A=o(F)`
