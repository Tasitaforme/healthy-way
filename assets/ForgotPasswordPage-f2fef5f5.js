import{o as c,s,h as x,k as d,j as a,F as p,i as l,B as h,_ as r,C as g,H as u}from"./index-eeab6bbc.js";import{S as w,H as b,a as j}from"./SignInPage.styled-8af60edd.js";import{S as y,f}from"./SignInForm.styled-5029c347.js";import{F,I as S,B as k,T as $}from"./SignUpImage.styled-b5be0528.js";import{w as T,a as v,b as D,c as M,d as B,e as I}from"./watch-desk@2x-2cdfc254.js";const P=c.create({baseURL:"https://healthy-way-app.onrender.com"}),E=async o=>{try{const{data:e}=await P.post("/api/auth/forgot-password",o);return e}catch(e){throw e.response.data}},H=s(x)`
  position: absolute;
  top: 30px;
  left: 10px;
`,W=s(y)`
