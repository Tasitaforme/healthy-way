import{m as c,s,g as x,i as d,j as a,F as p,h as l,_ as i,C as h}from"./index-e68b9b4e.js";import{B as g,H as u}from"./Components.styled-98f450c5.js";import{S as w,H as b,a as j}from"./SignInPage.styled-bfa3d2ea.js";import{S as f,f as y}from"./SignInForm.styled-fceb7448.js";import{F,I as S,B as k,T as $}from"./SignUpImage.styled-613e7376.js";import{w as T,a as v,b as D,c as M,d as B,e as I}from"./watch-desk@2x-2cdfc254.js";const P=c.create({baseURL:"https://healthy-way-app.onrender.com"}),E=async o=>{try{const{data:e}=await P.post("/api/auth/forgot-password",o);return e}catch(e){throw e.response.data}},H=s(x)`
  position: absolute;
  top: 30px;
  left: 10px;
`,W=s(f)`
