import{m as d,s,g as x,i as p,j as a,F as l,h,_ as n,C as g}from"./index-175388e3.js";import{B as u,H as w}from"./Components.styled-0170e2da.js";import{S as b,H as j,a as f}from"./SignInPage.styled-e05dc4cb.js";import{S as y,f as F}from"./SignInForm.styled-9b4b6306.js";import{M as S,F as k,I as $,B as T,T as M}from"./SignUpImage.styled-a0defe30.js";import{w as v,a as D,b as B,c as I,d as P,e as E}from"./watch-desk@2x-2cdfc254.js";const H=d.create({baseURL:"https://healthy-way-app.onrender.com"}),W=async o=>{try{const{data:e}=await H.post("/api/auth/forgot-password",o);return e}catch(e){throw e.response.data}},C=s(x)`
  position: absolute;
  top: 30px;
  left: 10px;
`,A=s(y)`
