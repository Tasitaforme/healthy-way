import{s as n,o as w,p as O,j as e,a as y,e as J,q as me,h as C,c as ue,d as ge,F as Y,g as R,u as S,t as fe,v as je,_ as A,w as we,r as f,x as X,y as ye,z as be,A as Ae,B as $,D as Fe,E as Ce,G as Re,C as Se}from"./index-175388e3.js";import{a as D,W as K,I as u,b as v,S as V,c as j,d as p,B as W,H as U,e as m,f as T,g as _,h as z,i as De,j as L,k as M}from"./Components.styled-0170e2da.js";import{M as ee,s as q,d as ke,b as te,l as ne,a as ie,c as re}from"./formikDiary-56711efe.js";import{C as se,A as ae,D as oe}from"./index-28c3c337.js";import{g as ve,a as Qe,R as Be,F as Ie,b as Pe,c as Ee,d as We}from"./getRecommendedFood-b4db1c81.js";const Ne=n.main`
  padding-top: 16px;
  padding-bottom: 80px;
...
`;se.register(ae);const mt=({title:t,arcColor:r,nutrient:a,baseNutrient:o=0})=>{const s=f.useMemo(()=>a>=o?100:Math.round(a/o*100),[o,a]),x=a>=o?[0]:[50],h={datasets:[{data:[s,100-s],backgroundColor:[r,"rgba(41, 41, 40, 1)"],borderColor:["rgba(69, 255, 188, 0)"],borderRadius:x,cutout:"80%"}]},d={id:"textCenter",beforeDatasetsDraw(i){const{ctx:c}=i,g=i.getDatasetMeta(0).data[0].x,b=i.getDatasetMeta(0).data[0].y;c.save(),c.font="14px Poppins",c.fillStyle="#B6B6B6",c.textAlign="center",c.textBaseline="middle",c.fillText(`${s}%`,g,b)}},l={id:"backgroundCircle",beforeDatasetsDraw(i){const{ctx:c}=i;c.save();const g=i.getDatasetMeta(0).data[0].x,b=i.getDatasetMeta(0).data[0].y,F=i.getDatasetMeta(0).data[0].innerRadius,k=i.getDatasetMeta(0).data[0].outerRadius,Q=k-F,pe=Math.PI/180;c.beginPath(),c.lineWidth=Q,c.strokeStyle="rgba(41, 41, 40, 1)",c.arc(g,b,k-Q/2,0,pe*360,!1),c.stroke()}};return e.jsxs(pt,{children:[e.jsx("div",{className:"doughnut",style:{height:48,width:48},children:e.jsx(oe,{plugins:[d,l],data:h})}),e.jsxs("div",{children:[e.jsx(v,{children:t}),e.jsxs(ht,{children:[e.jsxs(G,{children:[e.jsx(p,{children:"Goal:"}),e.jsx(m,{children:o||0})]}),e.jsxs(G,{children:[e.jsx(p,{children:"left:"}),e.jsx(m,{children:a>=o?0:o-a})]})]})]})]})},N=mt;function ut(){S();const{fat:t,protein:r,carbohydrate:a,BMR:o}=w(O),{meals:s,isLoading:x}=w(q),{fat:h,protein:d,carbohydrate:l,calories:i}=at(s),c=["Carbonohidrates","Protein","Fat"];return e.jsxs(ot,{children:[e.jsx(D,{children:"Food"}),x?e.jsx(X,{}):e.jsxs(ct,{children:[e.jsx(xt,{calories:i,baseCalories:o}),e.jsxs(lt,{children:[e.jsx(N,{title:c[0],arcColor:"#FFC4F7",nutrient:l,baseNutrient:a}),e.jsx(N,{title:c[1],arcColor:"#FFF3B7",nutrient:d,baseNutrient:r}),e.jsx(N,{title:c[2],arcColor:"#B6B6B6",nutrient:h,baseNutrient:t})]})]})]})}const gt=n.li`
  width: 100%;
