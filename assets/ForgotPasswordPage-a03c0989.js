import{k as x,s as o,c as p,h as l,j as e,F as h,b as g,_ as n,C as u}from"./index-32654d1b.js";import{B as w,H as b}from"./Components.styled-f8dc734f.js";import{S as f,H as j,a as y}from"./SignInPage.styled-6244d9c2.js";import{S as F,f as S}from"./SignInForm.styled-8dcd286a.js";import{M as k,F as $,I as T,B as M,T as v}from"./SignUpImage.styled-e19f9f96.js";import{w as D,a as B,b as I,c as P,d as E,e as H}from"./watch-desk@2x-2cdfc254.js";const W=x.create({baseURL:"https://healthy-way-app.onrender.com"}),C=async t=>{try{const{data:s}=await W.post("/api/auth/forgot-password",t);return s}catch(s){return s.response.data}},m=o(p)`
  position: absolute;
  top: 30px;
  left: 10px;
`,A=o(F)`
